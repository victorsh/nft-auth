...
import nftAuthAbi from './abis/nftAuthAbi.json'
import { connectWallet, checkMetamaskConnected } from '../lib/wallet'
        ...
        <div className="flex items-center flex-shrink-0 text-white mr-6">
          ...
          >
            <path d="M13.5 22.1c1.8-7.2 6.3-10.8 13.5-10.8 \
              10.8 0 12.15 8.1 17.55 9.45 3.6.9 6.75-.45 9.45-4.05-1.8 \
          ...
          {toggleMenu || windowSize.width > 1024 ?
            ...
            <div>
              <button
                ...
                className="\
                  inline-block text-sm px-4 py-2 mt-4 lg:mt-0\
