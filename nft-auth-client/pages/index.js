  ...
  const permissionCard = perm => {
    return (
      <div className='pl-1 pr-1 flex justify-center'>
        <svg className="w-6 h-6 stroke-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLineJoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
        {perm}
      </div>
    )
  }
